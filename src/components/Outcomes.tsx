...
export function Outcomes() {
  return <section aria-label="Business results" className="w-full bg-[#F4F7F4] py-24 md:py-36">
      <div className="mx-auto max-w-[1200px] px-6 text-center md:px-12">
        ...
        <div className="mt-16 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 md:gap-6">
          {OUTCOMES.map((outcome, index) => <Reveal key={outcome.label} delay={index * 0.1} className="flex flex-col items-center justify-center rounded-2xl bg-white p-10 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]">
