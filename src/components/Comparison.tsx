...
export function Comparison() {
  return <section className="w-full bg-cream py-24 text-forest md:py-36">
        ...
        <Reveal className="mt-16 overflow-x-auto pb-4">
          <table className="w-full min-w-[800px] border-collapse text-center">
            <caption className="sr-only">
              Scaleezy compared with traditional ERP, point of sale, and CRM
              tools
            </caption>
            <thead>
              <tr>
              ...
              return <tr key={row.feature}>
                    ...
                    <td className={`bg-lime/15 p-5 ${isLast ? 'rounded-b-2xl' : 'border-b border-forest/10 border-opacity-50'}`}>
                      <div className="flex justify-center">
                        <CellIcon value={row.scaleezy} emphasis />
                      </div>
                    </td>
                    <td className={`p-5 ${!isLast ? 'border-b border-forest/10' : ''}`}>
                      <div className="flex justify-center">
                        <CellIcon value={row.erp} />
                      </div>
                    </td>
                    <td className={`p-5 ${!isLast ? 'border-b border-forest/10' : ''}`}>
                      <div className="flex justify-center">
                        <CellIcon value={row.pos} />
                      </div>
                    </td>
                    <td className={`p-5 ${!isLast ? 'border-b border-forest/10' : ''}`}>
                      <div className="flex justify-center">
