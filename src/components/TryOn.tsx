...
{
  icon: UploadIcon,
  label: 'Customer uploads photo'
},
{
  icon: SparklesIcon,
  label: 'AI renders the garment'
},
{
  icon: TrendingUpIcon,
  label: 'Confidence increases'
},
{
              ...
              return (
                <Reveal key={s.label} delay={0.15 + i * 0.08}>
                  <div className="flex items-center gap-4 rounded-xl border border-emerald-950/10 bg-white px-4 py-3 shadow-sm">
                    ...
                    <span className="text-sm font-medium text-[#304238]">
                      {s.label}
                    </span>
                  </div>
                </Reveal>);
          ...
          <Reveal delay={0.5}>
            <div className="mt-8 rounded-2xl border border-emerald-700/20 bg-emerald-50 p-6">
              <p className="text-sm text-[#4b5e53]">
                Purchase confidence with Try-On
              </p>
