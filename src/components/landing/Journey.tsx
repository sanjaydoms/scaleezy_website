...
const STEPS = [
  { title: 'Procurement', copy: 'Bring every purchase decision into the same operational rhythm.', icon: ShoppingCartIcon },
  { title: 'Inventory', copy: 'Know where every size, colour, and piece belongs.', icon: PackageIcon },
  { title: 'Product Upload', copy: 'Move a collection from catalog to commerce without duplicate work.', icon: UploadCloudIcon },
  { title: 'Customer', copy: 'Keep every preference, purchase, and conversation close to the team.', icon: UsersIcon },
  { title: 'CRM', copy: 'Turn everyday visits into relationships that keep growing.', icon: HeartHandshakeIcon },
  { title: 'Marketing', copy: 'Create thoughtful outreach rooted in what customers actually love.', icon: MegaphoneIcon },
  { title: 'Virtual Try-On', copy: 'Help shoppers feel certain before they purchase.', icon: SparklesIcon },
  { title: 'Checkout', copy: 'Let every detail follow the customer through a simple sale.', icon: CreditCardIcon },
  { title: 'Delivery', copy: 'Carry the same care from package to doorstep.', icon: TruckIcon },
  { title: 'Retention', copy: 'Turn a first purchase into a lasting customer relationship.', icon: GiftIcon },
];

const BACKGROUND_MOTIFS = [
  { icon: ShoppingCartIcon, className: 'left-[5%] top-[15%]' },
  { icon: PackageIcon, className: 'right-[6%] top-[23%]' },
  { icon: UsersIcon, className: 'left-[10%] top-[42%]' },
  { icon: MegaphoneIcon, className: 'right-[10%] top-[52%]' },
  { icon: CreditCardIcon, className: 'left-[5%] top-[69%]' },
  { icon: TruckIcon, className: 'right-[5%] top-[82%]' },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <path d="M0 170C220 70 360 300 545 225C730 150 790 55 1020 175C1200 268 1315 185 1440 102" stroke="currentColor" strokeWidth="1.5" strokeDasharray="5 12" />
          <path d="M0 670C185 560 360 770 540 660C710 550 805 770 1000 650C1160 550 1290 710 1440 620" stroke="currentColor" strokeWidth="1.5" strokeDasharray="5 12" />
          <path d="M0 1050C260 960 350 1140 570 1040C760 955 855 1140 1080 1035C1230 965 1350 1015 1440 955" stroke="currentColor" strokeWidth="1.5" strokeDasharray="5 12" />
        </svg>
