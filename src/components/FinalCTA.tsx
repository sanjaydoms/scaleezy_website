...
export function FinalCTA() {
  return <section id="cta" className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#121712]">
      <motion.img src={IMAGES.ctaClosing} alt="Fashion boutique closing for the day with warm dimmed lights" className="absolute inset-0 h-full w-full object-cover opacity-35" initial={{
      scale: 1.1
    }} whileInView={{
      scale: 1
    }} viewport={{
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        ...
        <motion.h2 className="font-serif-display mt-6 text-5xl leading-[0.98] text-cream md:text-8xl" initial={{
        opacity: 0,
        y: 40
      }} whileInView={{
        opacity: 1,
        ...
        <motion.p className="mx-auto mt-7 max-w-2xl text-base font-light leading-relaxed text-cream/70 md:text-lg" initial={{
        opacity: 0,
        y: 20
      }} whileInView={{
        opacity: 1,
        ...
        <motion.div className="mt-11 flex flex-col justify-center gap-4 sm:flex-row" initial={{
        opacity: 0,
        y: 20
      }} whileInView={{
        opacity: 1,
